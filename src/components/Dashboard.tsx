...
import { Star, TrendingUp, Users, MessageCircle, Clock, MapPin, Heart, Linkedin } from 'lucide-react';
...
const Dashboard: React.FC<DashboardProps> = ({ onViewChange }) => {
  ...
  const userMatches = mockSkillListings.filter(listing => 
    user.matches?.includes(listing.id)
  );

  const handleContactMatch = (listing: any) => {
    // Mock LinkedIn profiles for demonstration
    const mockLinkedInProfiles = {
      '2': 'https://linkedin.com/in/sarahchen',
      '3': 'https://linkedin.com/in/marcusjohnson',
      '4': 'https://linkedin.com/in/elenarodriguez',
      '5': 'https://linkedin.com/in/davidpark',
      '6': 'https://linkedin.com/in/amyliu',
      '7': 'https://linkedin.com/in/robertosilva'
    };

    const linkedinUrl = mockLinkedInProfiles[listing.userId as keyof typeof mockLinkedInProfiles] || 'https://linkedin.com';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-400">Matches</p>
                <p className="text-2xl font-bold text-white">{user.matches?.length || 0}</p>
              </div>
            </div>
          </div>
            ...
            {userMatches.length > 0 && (
              <div className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-6">
                ...
                <div className="space-y-4">
                  {userMatches.slice(0, 3).map((listing) => (
                    <div
                      key={listing.id}
                      className="border border-green-600 rounded-lg p-4 bg-green-900 bg-opacity-20"
                    >
            ...
            <div className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className={`font-medium ${user.linkedinProfile ? 'text-green-400' : 'text-yellow-400'}`}>
                    {user.linkedinProfile ? 'Complete' : 'Pending'}
                  </span>
                </div>
                <div className="flex items-center justify-between text-sm">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-sm">
                    <p className="text-white font-medium">Perfect match found!</p>
                    <p className="text-gray-400">Sarah wants to learn Web Development</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                  <div className="text-sm">
                    <p className="text-white font-medium">New match created!</p>
                    <p className="text-gray-400">Connected with Marcus Johnson</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-gray-400">Photography lesson with David</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
